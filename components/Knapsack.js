...
export default class Knapsack extends Component {
  constructor() {
    super();
    this.algorithmInfo = [
      { indx: 0, label: 'Most Credits per Hour', info: "Knapsack uses blabla...", data: knapsack(data, 200) },
      { indx: 1, label: 'Priorities Mandatory Courses', info: "Manda uses blabla...", data: manda(data, 200) },
    ];
    this.state = {
